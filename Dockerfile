...
COPY model-cache/chroma/onnx_models/all-MiniLM-L6-v2/onnx.tar.gz /tmp/chroma-onnx.tar.gz
RUN mkdir -p /root/.cache/chroma/onnx_models/all-MiniLM-L6-v2 && \
    tar -xzf /tmp/chroma-onnx.tar.gz -C /root/.cache/chroma/onnx_models/all-MiniLM-L6-v2 && \
    rm /tmp/chroma-onnx.tar.gz
